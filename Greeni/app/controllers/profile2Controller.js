'use strict';
app.controller('profile2Controller', ['$scope', '$rootScope', '$location', '$routeParams', 'personService', 'authService', function ($scope, $rootScope, $location, $routeParams, personService, authService, ) {
